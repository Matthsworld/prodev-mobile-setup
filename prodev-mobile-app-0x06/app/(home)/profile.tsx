      ...
      <SafeAreaView className="flex-1 p-4">
        ...
        <View className="h-[350px] gap-3 bg-white rounded-md p-4 mb-4">
          {[
            ...
            <Pressable key={index} className="flex-row items-center justify-between mb-2">
              <View className="flex-row items-center gap-4">
                <View className="w-12 h-12 bg-[#0601B4]/10 items-center justify-center rounded-full">
                  {item.icon}
                </View>
                <View>
                  <Text className="text-lg font-normal mb-2">{item.title}</Text>
                  <Text className="font-thin text-gray-700">{item.subtitle}</Text>
                </View>
              </View>
